...
<AccordionGroup>
  ...
  <Accordion title="api.runtime.state">
    ...
    <Warning>
    `openKeyedStore`, `openSyncKeyedStore`, `openChannelIngressQueue`, and `openChannelIngressDrain` are available only to bundled plugins and trusted official plugin installations in this release.
    </Warning>
